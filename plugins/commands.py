...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[           
            InlineKeyboardButton('📢 Uᴩᴅᴀᴛᴇꜱ 📢', url=f'https://t.me/FilmsWithSinhalaSub')
            ],[
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton("🌼 Cʜᴀɴɴᴇʟ", url="https://t.me/FilmsWithSinhalaSub")
            ],[      
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        try:
            ...
            return
        btn = [[InlineKeyboardButton("Jᴏɪɴ Mʏ Cʜᴀɴɴᴇʟ ☘️", url=https://t.me/FilmsWithSinhalaSub)]]
